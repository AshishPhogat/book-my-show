    ...
    return(
        ...
        <div className="container mx-auto px-4 items-center  flex justify-between">
            ...
            <div className="flex items-center gap-5 ">
                <span className = "text-sm font-normal text-bms-200 flex items-center pb-1.5 font-light ">
                        Bengaluru <IoMdArrowDropdown className="text-gray-50 text-lg" />
                </span>
                <button className="bg-red-600 py-1 px-3 rounded-md w-18 text-xs font-light">Sign in</button>
